...
<html lang="en">
    ...
    <head>
        ...
        <?php $this->registerJsFile('@web/static/common/js/app.js');?>
        <?php $this->endBody() ?>
    </head>
    <!-- END HEAD -->
    ...
    <?php $this->beginBody() ?>
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                    <span style="line-height: 50px; color: #0081e6;font-size:18px;">魔页经销商系统</span>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <!--<li class="dropdown dropdown-user">
                            ...
                            <!--<ul class="dropdown-menu dropdown-menu-default">
                                <li><a href="<?=Url::toRoute('admin/edit?uid='.Yii::$app->user->identity->id)?>"><i class="icon-user"></i> 个人主页 </a></li>
...
<!--                                <li><a href="#"><i class="icon-lock"></i> 锁屏 </a></li>
                        ...
                        <li class="dropdown dropdown-quick-sidebar-toggler">
                            <a href="<?=Url::toRoute('login/logout')?>" class="">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> 
						...
						<?php if( !empty($this->params['backUrl'] ) ):?>
						<a class="btn blue" style="float:right" href="<?=$this->params['backUrl'] ?>">返  回<i class="fa fa-mail-reply"></i></a>
						<?php endif;?>
                    </h3>
                    <!-- END PAGE TITLE-->
