	...
	$columns[] = [
        ...
        'buttons' => [
            ...
            'delete' => function ($url, $model, $key) {
                if ($model['status'] == 1){
                    return Html::a('<i class="fa fa-times"></i> 停用', ['delete', 'id'=>$key,'status'=>0], [
                        'title' => Yii::t('app', '停用'),
                        'class' => 'btn btn-xs red ajax-get confirm'
                    ]);
                }else{
                    return Html::a('<i class="fa fa-times"></i> 启用', ['delete', 'id'=>$key,'status'=>1], [
                        'title' => Yii::t('app', '启用'),
                        'class' => 'btn btn-xs red ajax-get confirm'
                    ]);
                }
...
<div class="portlet light portlet-fit portlet-datatable bordered">
    ...
    <div class="portlet-body">
        ...
        <div>
            <?= $this->render('_search', ['model' => $searchModel,'levelSelect' => $levelSelect,
            'level0Select' => $level0Select,'level1Select' => $level1Select,]); ?>
        </div>
