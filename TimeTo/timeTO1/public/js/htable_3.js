...
var Htable = {
    ...
    create: function (id, hack) {
        ...
        t.render = function () {
            ...
            var scrollPanelHeight = (t.data.length-1) * 35 + t.scrollTable.find("thead:first").height();
            var scrollPanelHeight = (t.data.length-1) * 35 + t.scrollTable.find("thead:first").height();
...
//            });
            ...
            //alert(t.scrollTable.css("z-index"));
