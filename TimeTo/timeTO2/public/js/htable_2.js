...
var Htable = {
    ...
    create: function (id, hack) {
        ...
        t.render = function () {
            ...
            var fixPanelHeight;
            var fixPanelWidth;
            var scrollPanelHeight = t.data.length * 35 + t.scrollTable.find("thead:first").height();
...
//            console.debug("t.grandfather" + t.grandfather.height());
//            console.debug("t.father" + t.father.height());
//            console.debug("t.scrollTable" + t.scrollTable.height());
...
//            veilFloat.width(t.floatTitle.width()).height(t.floatTitle.height());
        ...
        t.hideThead = function () {
            //root.find("thead").css("visibility", "collapse");
        ...
        t.sort = function (field) {
            ...
            if (t.orderBy === undefined) {
                data1.sort(function (a, b) {
                    if (option["sortby"]) {
                        return a[option["sortby"]] <= b[option["sortby"]]? -1 : 1;
                    } else
