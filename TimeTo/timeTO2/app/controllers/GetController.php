...
class GetController extends Controller {
    ...
    public function nightamountAction() {
    ...
    public function daysamountAction() {
    ...
    public function fundAnalyAction() {//
        $id = 44;
        $today = $this->request->get('day');
        //$today = "2016-09-21";
        $recieveMonth = date("n", strtotime("$today"));
        ...
        $ch = curl_init();
        $url = "http://10.127.133.91:8080/data/dataservice/getconfig.do?id=" . $id .
                "&begin_day=" . $start . "&end_day=" . $end . "&month_day=" . $month_today . "&total_day=" . $month_today;
...
//        echo $month_today."<br/>";
    ...
    public function currentDepositAction() {//
        $id = 46;
        $today = $this->request->get('day');
        $recieveMonth = date("n", strtotime("$today"));
        $nowMonth = date("n");
        ...
        //http://10.127.133.91:8080/data/dataservice/getconfig.do?id=46&begin_day=20160901&end_day=20160930&month_day=20160930&total_day=20160930
        $ch = curl_init();
        $url = "http://10.127.133.91:8080/data/dataservice/getconfig.do?id=" . $id .
                "&begin_day=" . $start . "&end_day=" . $end . "&month_day=" . $month_today . "&total_day=" . $month_today;
...
//        echo $month_today."<br/>";
    ...
    public function aAction() {
        ...
        //print_r($this->getDI()->get("cookies"));
        //echo $this->getDI()->get("cookies")->getExpiration();
    }

    public function offlineDealAction() {
        $conn = MySqlDB::getConnection();
        $sql = "select * from rt_offline";
        $result = $conn->fetchAll($sql, Db::FETCH_ASSOC);
        echo json_encode($result);
    }
    
    public function kpiAction() {//首页
        $id = 47;
