...
(function($, window) {
	...
	// -==========================================================================================
//		var warpper = document.getElementsByClassName('mui-content')[0];
//		
//		if(touch.deltaY == 0){
//			mui.lastDeltaY = 0;
//		}
//		if(mui.lastDeltaY){
//			var offsetT = touch.deltaY-mui.lastDeltaY + warpper.getBoundingClientRect().top;
//		}else{
//			var offsetT = touch.deltaY + warpper.getBoundingClientRect().top;
//		}
//		warpper.style.webkitTransform = 'translateY('+offsetT+'px)';
//		mui.lastDeltaY = touch.deltaY;
	//==============================================================================================
	};
	...
	var Scroll = $.Class.extend({
		...
		_flick: function(e) {
			...
			if (this.options.momentum && detail.flickTime < 300) {
				...
				this._momentum(this.x, detail.flickDistanceX, detail.flickTime, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
					destination: newX,
					duration: 0
				};
				momentumY = this.hasVerticalScroll ? 
				this._momentum(this.y, detail.flickDistanceY, detail.flickTime, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {
					destination: newY,
					duration: 0
				};
