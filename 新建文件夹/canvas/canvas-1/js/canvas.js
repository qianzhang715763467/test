var tigger = {};
function myCanvas(val,data){
	if(val == null)return;
	$(val).children("canvas").remove();
	var self = document.getElementById(val);
...
function drawCanvas(id,data){
	...
	this.draw = function(){
		...
		var myCanvas = document.createElement('canvas');
			myCanvas.setAttribute('width',(w-bor)+'px');
			myCanvas.setAttribute("height",(h-bor)+'px');
