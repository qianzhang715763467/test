function chartsArr(doms){
	...
	var chartsArr = {
		...
		3:function(){
			...
			var option = {
			    title : {
			        subtext: getData[3].subtext
			    },
			    tooltip : {
			        trigger: 'axis'
			    },
			    legend: {
			        data: getData[3].seriesName
			    },
			    calculable : true,
			    xAxis : [
			        {
