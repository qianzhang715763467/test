...
+function ($) {
  ...
  Router.prototype.loadPage = function(url, noAnimation, replace, reload, leftToRight) {
    ...
    var url = param.url, noAnimation = param.noAnimation, replace = param.replace, leftToRight = param.leftToRight;
    ...
    this.getPage(url, function(page, extra) {
      ...
      this.animatePages(this.getCurrentPage(), page, leftToRight, noAnimation);
    });
  }
